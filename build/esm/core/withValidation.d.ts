...
export declare const withValidationOnBlur: <I extends FieldInputElement, V extends FieldValue = FieldValue, P extends Record<string, unknown> = Record<string, unknown>>(Cmp: React.ComponentType<P & {
